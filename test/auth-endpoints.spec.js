...
describe('Auth Endpoints', function() {
  ...
  describe(`POST /auth/login`, () => {
    ...
    requiredFields.forEach(field => {
      ...
      it(`responds with 400 reqired error when '${field}' is missing`, () => {
    ...
    it(`Respods 400 'invalid user_name or password' when bad user_name`, () => {
    ...
    it( `responds 4-- 'invalid user_name or password' when bad user_name`, () => {
      ...
      .expect(400, { error: `Incorect user_name or password` })
    })

    it(`responds 200 and JWT auth token using secret when valid credentials`, () => {
      const userValidCredintials = {
        user_name: testUser.user_name,
        password: testUser.password,
      }
